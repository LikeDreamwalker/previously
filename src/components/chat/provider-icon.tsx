...
// Brand SVGs adapted from Vercel's open-agents (MIT). Qwen is from
// simple-icons (CC0). Keyed by the models.dev provider key.
...
// Qwen (Alibaba / Tongyi) — from simple-icons (CC0).
function QwenIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="#6950EF" {...props}>
...
/** Keyed by the models.dev provider key. */
...
/** Brand prefixes to strip from model names for compact display. */
 ...
 * e.g. "DeepSeek V4 Flash" → "V4 Flash". Only strips a clean leading
 * "Brand " word — names where the brand is embedded (e.g. "Qwen3-Coder")
 * or that carry no brand prefix (e.g. "GPT-5.4") are left unchanged.
 */
